...
MK =   [['22B0211012','22B0211022','22B0211032','22B0211042','22B0211073','22B0211063','22B0211083','22B0211053',],
        ['Agama Islam','Pancasila','Bahasa Indonesia','CINTA','Pengantar Pemrograman','PTI','Kalkulus Dasar','Sains Terpadu'],
        [2,2,2,2,3,3,3,3],
        ['Jumat','Jumat','Jumat','Kamis','Selasa','Jumat','Selasa','Rabu'],
        ['07.30-09.10','13.30-15.10','09.20-11.00','09.20-11.00','13.30-15.10','15.20-17.00','07.30-09.10','15.20-17.00']]


tp = 65
print(f"{BIO[7].upper().center(tp)}")
print(f"{BIO[9].upper().center(tp)}")
print(f"{BIO[10].upper().center(tp)}")
print(f"{BIO[3].upper().center(tp)}")
print()

nama_lengkap = "NURUL SALSABILLAH"  
nim = "231031087"  
